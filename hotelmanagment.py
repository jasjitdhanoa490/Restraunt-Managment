...
Tops = Frame(root,bg="red",width = 1600,height=50,relief=RAISED)
Tops.pack(side=TOP)
...
def price():
    ...
    lblinfo.grid(row=0, column=0)
    lblinfo = Label(roo, font=('aria', 15,'bold'), text="Menu", fg="red", anchor=CENTER)
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="35", fg="steel blue", anchor=E)
